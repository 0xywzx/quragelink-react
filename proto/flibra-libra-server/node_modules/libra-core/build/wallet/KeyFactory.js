...
const KeyPrefixes_1 = __importDefault(require("../constants/KeyPrefixes"));
const Eddsa_1 = require("../crypto/Eddsa");
const Hkdf_1 = require("../crypto/Hkdf");
const Pbkdf_1 = require("../crypto/Pbkdf");
...
class Seed {
    static fromMnemonic(words, salt = 'LIBRA') {
        ...
        const bytes = new Pbkdf_1.Pbkdf('sha3-256').pbkdf2(mnemonic.toBytes(), Buffer.from(`${KeyPrefixes_1.default.MnemonicSalt}${salt}`), 2048, 32);
