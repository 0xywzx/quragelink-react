...
proto.types.LedgerInfo.prototype.getTransactionAccumulatorHash_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getTransactionAccumulatorHash()));
};
/**
 * optional bytes transaction_accumulator_hash = 2;
...
proto.types.LedgerInfo.prototype.getTransactionAccumulatorHash_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getTransactionAccumulatorHash()));
};
...
proto.types.LedgerInfo.prototype.getConsensusDataHash_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getConsensusDataHash()));
};
/**
 * optional bytes consensus_data_hash = 3;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.LedgerInfo.prototype.getConsensusDataHash_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getConsensusDataHash()));
};
/** @param {!(string|Uint8Array)} value */
...
proto.types.LedgerInfo.prototype.getConsensusBlockId_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getConsensusBlockId()));
};
/**
 * optional bytes consensus_block_id = 4;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.LedgerInfo.prototype.getConsensusBlockId_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getConsensusBlockId()));
};
/** @param {!(string|Uint8Array)} value */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.types.LedgerInfoWithSignatures.toObject = function (includeInstance, msg) {
        var f, obj = {
            signaturesList: jspb.Message.toObjectList(msg.getSignaturesList(), proto.types.ValidatorSignature.toObject, includeInstance),
...
proto.types.LedgerInfoWithSignatures.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.types.ValidatorSignature.serializeBinaryToWriter);
    }
    f = message.getLedgerInfo();
    if (f != null) {
        writer.writeMessage(2, f, proto.types.LedgerInfo.serializeBinaryToWriter);
    }
};
/**
...
proto.types.LedgerInfoWithSignatures.prototype.getSignaturesList = function () {
    return /** @type{!Array<!proto.types.ValidatorSignature>} */ (jspb.Message.getRepeatedWrapperField(this, proto.types.ValidatorSignature, 1));
};
...
proto.types.LedgerInfoWithSignatures.prototype.getLedgerInfo = function () {
    return /** @type{?proto.types.LedgerInfo} */ (jspb.Message.getWrapperField(this, proto.types.LedgerInfo, 2));
};
...
proto.types.ValidatorSignature.prototype.getValidatorId_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getValidatorId()));
};
/**
 * optional bytes validator_id = 1;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.ValidatorSignature.prototype.getValidatorId_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getValidatorId()));
};
/** @param {!(string|Uint8Array)} value */
