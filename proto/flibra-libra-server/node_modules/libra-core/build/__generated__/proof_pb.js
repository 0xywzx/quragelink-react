...
proto.types.AccumulatorProof.prototype.getNonDefaultSiblingsList_asB64 = function () {
    return /** @type {!Array<string>} */ (jspb.Message.bytesListAsB64(this.getNonDefaultSiblingsList()));
};
/**
 * repeated bytes non_default_siblings = 2;
...
proto.types.AccumulatorProof.prototype.getNonDefaultSiblingsList_asU8 = function () {
    return /** @type {!Array<!Uint8Array>} */ (jspb.Message.bytesListAsU8(this.getNonDefaultSiblingsList()));
};
...
proto.types.SparseMerkleProof.prototype.getLeaf_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getLeaf()));
};
/**
 * optional bytes leaf = 1;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.SparseMerkleProof.prototype.getLeaf_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getLeaf()));
};
/** @param {!(string|Uint8Array)} value */
...
proto.types.SparseMerkleProof.prototype.getBitmap_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getBitmap()));
};
/**
 * optional bytes bitmap = 2;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.SparseMerkleProof.prototype.getBitmap_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getBitmap()));
};
/** @param {!(string|Uint8Array)} value */
...
proto.types.SignedTransactionProof.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.types.AccumulatorProof.serializeBinaryToWriter);
    }
    f = message.getTransactionInfo();
    if (f != null) {
        writer.writeMessage(2, f, transaction_info_pb.TransactionInfo.serializeBinaryToWriter);
    }
};
/**
...
proto.types.SignedTransactionProof.prototype.getLedgerInfoToTransactionInfoProof = function () {
    return /** @type{?proto.types.AccumulatorProof} */ (jspb.Message.getWrapperField(this, proto.types.AccumulatorProof, 1));
};
...
proto.types.SignedTransactionProof.prototype.getTransactionInfo = function () {
    return /** @type{?proto.types.TransactionInfo} */ (jspb.Message.getWrapperField(this, transaction_info_pb.TransactionInfo, 2));
};
...
proto.types.AccountStateProof.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(3, f, proto.types.SparseMerkleProof.serializeBinaryToWriter);
    }
};
/**
 * optional AccumulatorProof ledger_info_to_transaction_info_proof = 1;
...
proto.types.AccountStateProof.prototype.getTransactionInfoToAccountProof = function () {
    return /** @type{?proto.types.SparseMerkleProof} */ (jspb.Message.getWrapperField(this, proto.types.SparseMerkleProof, 3));
};
...
proto.types.EventProof.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(3, f, proto.types.AccumulatorProof.serializeBinaryToWriter);
    }
};
/**
 * optional AccumulatorProof ledger_info_to_transaction_info_proof = 1;
...
proto.types.EventProof.prototype.getTransactionInfoToEventProof = function () {
    return /** @type{?proto.types.AccumulatorProof} */ (jspb.Message.getWrapperField(this, proto.types.AccumulatorProof, 3));
};
/** @param {?proto.types.AccumulatorProof|undefined} value */
