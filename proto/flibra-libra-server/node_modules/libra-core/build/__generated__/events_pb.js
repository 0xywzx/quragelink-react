...
proto.types.Event.prototype.getEventData_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getEventData()));
};
/**
 * optional bytes event_data = 3;
...
proto.types.Event.prototype.getEventData_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getEventData()));
};
...
proto.types.EventWithProof.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getEvent();
    if (f != null) {
        writer.writeMessage(3, f, proto.types.Event.serializeBinaryToWriter);
    }
    f = message.getProof();
    if (f != null) {
        writer.writeMessage(4, f, proof_pb.EventProof.serializeBinaryToWriter);
    }
};
/**
...
proto.types.EventWithProof.prototype.getEvent = function () {
    return /** @type{?proto.types.Event} */ (jspb.Message.getWrapperField(this, proto.types.Event, 3));
};
...
proto.types.EventWithProof.prototype.getProof = function () {
    return /** @type{?proto.types.EventProof} */ (jspb.Message.getWrapperField(this, proof_pb.EventProof, 4));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.types.EventsList.toObject = function (includeInstance, msg) {
        var f, obj = {
            eventsList: jspb.Message.toObjectList(msg.getEventsList(), proto.types.Event.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.types.EventsList.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.types.Event.serializeBinaryToWriter);
    }
};
/**
...
proto.types.EventsList.prototype.getEventsList = function () {
    return /** @type{!Array<!proto.types.Event>} */ (jspb.Message.getRepeatedWrapperField(this, proto.types.Event, 1));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.types.EventsForVersions.toObject = function (includeInstance, msg) {
        var f, obj = {
            eventsForVersionList: jspb.Message.toObjectList(msg.getEventsForVersionList(), proto.types.EventsList.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.types.EventsForVersions.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.types.EventsList.serializeBinaryToWriter);
    }
};
/**
...
proto.types.EventsForVersions.prototype.getEventsForVersionList = function () {
    return /** @type{!Array<!proto.types.EventsList>} */ (jspb.Message.getRepeatedWrapperField(this, proto.types.EventsList, 1));
};
