...
proto.mempool.AddTransactionWithValidationRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, transaction_pb.SignedTransaction.serializeBinaryToWriter);
    }
...
proto.mempool.AddTransactionWithValidationRequest.prototype.getSignedTxn = function () {
    return /** @type{?proto.types.SignedTransaction} */ (jspb.Message.getWrapperField(this, transaction_pb.SignedTransaction, 1));
};
...
proto.mempool.AddTransactionWithValidationResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getStatus();
    if (f != null) {
        writer.writeMessage(2, f, mempool_status_pb.MempoolAddTransactionStatus.serializeBinaryToWriter);
    }
};
/**
...
proto.mempool.AddTransactionWithValidationResponse.prototype.getStatus = function () {
    return /** @type{?proto.mempool.MempoolAddTransactionStatus} */ (jspb.Message.getWrapperField(this, mempool_status_pb.MempoolAddTransactionStatus, 2));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.mempool.GetBlockRequest.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            transactionsList: jspb.Message.toObjectList(msg.getTransactionsList(), proto.mempool.TransactionExclusion.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.mempool.GetBlockRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.mempool.TransactionExclusion.serializeBinaryToWriter);
    }
};
/**
...
proto.mempool.GetBlockRequest.prototype.getTransactionsList = function () {
    return /** @type{!Array<!proto.mempool.TransactionExclusion>} */ (jspb.Message.getRepeatedWrapperField(this, proto.mempool.TransactionExclusion, 2));
};
...
proto.mempool.GetBlockResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getBlock();
    if (f != null) {
        writer.writeMessage(1, f, transaction_pb.SignedTransactionsBlock.serializeBinaryToWriter);
    }
};
/**
...
proto.mempool.GetBlockResponse.prototype.getBlock = function () {
    return /** @type{?proto.types.SignedTransactionsBlock} */ (jspb.Message.getWrapperField(this, transaction_pb.SignedTransactionsBlock, 1));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.mempool.CommitTransactionsRequest.toObject = function (includeInstance, msg) {
        var f, obj = {
            transactionsList: jspb.Message.toObjectList(msg.getTransactionsList(), proto.mempool.CommittedTransaction.toObject, includeInstance),
...
proto.mempool.CommitTransactionsRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getTransactionsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.mempool.CommittedTransaction.serializeBinaryToWriter);
    }
...
proto.mempool.CommitTransactionsRequest.prototype.getTransactionsList = function () {
    return /** @type{!Array<!proto.mempool.CommittedTransaction>} */ (jspb.Message.getRepeatedWrapperField(this, proto.mempool.CommittedTransaction, 1));
};
